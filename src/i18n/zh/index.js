...
import { decisionZh, priorZh, savesZh } from './decisions.js';
// The minigame prose is its own file for size; it lives in the same flat ui dictionary.
export const zh = { ui: { ...ui, ...minigames, ...campusZh, ...stuckZh, ...hintsZh, ...examZh, ...deskZh, ...rollZh, ...rechargeZh, ...menuZh, ...draftZh, ...preEnrolZh, ...decisionZh, ...priorZh, ...savesZh }, events, meetings, ...misc };
