...
export function createRun(seed = Date.now() >>> 0, answers = {}) {
  const s = {
    ...
    milestones: { prelim: null, prelimMonth: 23, prelimAttempts: 0, proposal: null, proposalMonth: 44, proposalAttempts: 0, defense: null, defenseMonth: null, defenseAttempts: 0, thesisStarted: false, graduated: false },
