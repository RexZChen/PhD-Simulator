...
export const popIns = {
  good: [
    ...
    { id: 'nameit', line: 'They give the thing a name. Just a name, four syllables, thirty seconds. It is now a contribution rather than a set of experiments.', effects: { hype: 5, writingQuality: 3, confidence: 4 }, quality: 4 },
    { id: 'theirdraft', line: 'They pull up their own rejected draft from 2021 to show you what a reviewer meant by “unmotivated.” Nobody has ever shown you one of these before.', effects: { writingQuality: 6, hope: 4, trust: 3 }, quality: 2 },
    { id: 'phone', line: 'They pick up the phone in front of you and get you the data by Friday. Eleven weeks of email, resolved in ninety seconds by somebody with tenure.', effects: { evidence: 7, progress: 3, energy: 2 }, quality: 2 },
    { id: 'permission', line: '“You do not need my permission for that.” It turns out you have been waiting for permission for two weeks without noticing.', effects: { confidence: 6, stress: -6, progress: 3 }, quality: 1 },
    { id: 'sit', line: 'They ask how you are and then do not say anything else, which is the technique, and it works, and you tell them.', effects: { stress: -9, hope: 5, trust: 5 }, quality: 0 },
    { id: 'kill', line: '“That is not going to work and I think you already know that.” Said kindly, four weeks earlier than anyone else would have said it.', effects: { scope: -10, stress: -4, progress: -3, novelty: 4 }, quality: 2 },
  ],
  bad: [
    ...
    { id: 'whoareyou', line: 'A pause of about a second and a half while they place you. You have been in this lab for two years and you both pretend it did not happen.', effects: { confidence: -6, hope: -4 }, quality: 0 },
    { id: 'otherstudent', line: 'They answer your question with an update about somebody else\'s project, at length, with obvious enthusiasm.', effects: { satisfaction: -3, stress: 4, hope: -3 }, quality: 0 },
    { id: 'reversed', line: 'They ask you a question about your own numbers that you cannot answer, and then wait, and then say “find out,” and go back to their screen.', effects: { stress: 8, evidence: 3, confidence: -4 }, quality: 1 },
    { id: 'rewrite', line: '“Rewrite the introduction.” You rewrote the introduction on Tuesday, at their instruction. This is a different instruction about the same introduction.', effects: { draft: -6, writingQuality: 3, stress: 6 }, quality: 0 },
    { id: 'deadlinemoved', line: 'They suggest, casually, aiming for the venue six weeks earlier instead. They say “it is basically ready.” It is not basically ready.', effects: { stress: 10, pressure: 8, hope: -3 }, quality: -1 },
    { id: 'email', line: 'They type throughout. At the end they say “sorry, this is about you actually,” and turn the screen, and it is about you, and it is fine, and the ten minutes were still like that.', effects: { energy: -3, stress: 3 }, quality: 0 },
    { id: 'praise', line: 'They say the work is good, in a general way, without having read it. You can tell. You take it anyway, because you needed something today.', effects: { hope: 4, confidence: 2, trust: -2 }, quality: 0 },
  ],
  absent: [
    ...
    { id: 'voices', line: 'Voices inside. You wait forty seconds in the corridor, decide that waiting in a corridor is a thing you are now doing, and go back to your desk.' },
    { id: 'coat', line: 'The coat is on the chair and the screen is on and the room is empty. This configuration has persisted for two days.' },
    { id: 'nextweek', line: 'A postdoc, passing: “They are at a workshop. No, the other one. Next week, probably.” Nobody says which next week.' },
    { id: 'occupied', line: 'Someone else is in there, sitting where you would sit, and they have been in there for fifty minutes, and you look at your phone as though you had somewhere to be.' },
  ],
};
