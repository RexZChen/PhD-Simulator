...
export default [
  { id: 'fired_tell', title: 'They have stopped coming in', category: 'lab', scene: 'lab', speaker: 'narrator',
    ...
    choices: [
      c('ask', 'Ask them, directly, if they are all right', 'The thing almost nobody does', { energy: -3, labBond: 8, stress: 4 },
        { watchFired: true, followUps: [{ id: 'fired_told', delay: 3 }],
  ...
  { id: 'fired_after', title: 'You could just message them', category: 'peer', scene: 'home', speaker: 'narrator',
    ...
    text: 'It has been a while now. Their name comes up because something they built is still in your pipeline, with their initials in a comment, and it works, and it has worked every day since they left.\n\nYou have their number. You have had their number the whole time. The message is four words long and you have not sent it, and the reason you have not sent it is not that you are busy, and you know that, and you have known it the whole time.',
    choices: [
      ...
      c('draft', 'Draft it and leave it', 'You will send it. You will send it this week.', { stress: 6, hope: -4 },
        { flags: { firedUnsent: true },
          draft: { to: 'To: {fired}', subject: '(no subject)', body: 'hey — long time. I was in the pipeline today and your initials are still in a comment in there and it still works.\n\nHow are you? Genuinely.\n\n' },
