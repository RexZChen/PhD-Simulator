...
export default [
  ...
  { id: 'letter', title: 'Your recommender is “on it”', category: 'application', scene: 'home', probability: 1, cooldown: 99, conditions: { phase: 'application' },
    ...
    choices: [c('nudge', 'Send a polite, terrified reminder', 'Communication check', { energy: -2 }, { check: { skill: 'communication', difficulty: 40 }, successEffects: { confidence: 3 }, failureEffects: { hope: -4, stress: 5 }, successText: 'The portal changes to “received.” They sent it from the workshop bathroom. You stop refreshing that row.', failureText: 'They submit it four hours late. The portal records the delay; at least the letter is there.' }),
      c('backup', 'Ask for a short letter they can submit today', 'On time, with less detail', { energy: -4, hope: -1 }, { result: 'They send three paragraphs before lunch. It confirms the work you did, without finding much room for adjectives.' })] },
