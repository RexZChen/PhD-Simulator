...
export const firstNames = ['Ada', 'Bram', 'Calla', 'Dev', 'Elio', 'Fenna', 'Gideon', 'Halia', 'Idris', 'Juno', 'Kalinda', 'Lior', 'Maren', 'Nils', 'Odalys', 'Petra', 'Quill', 'Rune', 'Saoirse', 'Tobiah', 'Ulla', 'Vasco', 'Wren', 'Xiomara', 'Yael', 'Zephyr', 'Anouk', 'Bastian', 'Cosima', 'Dorian', 'Esperanza', 'Farid', 'Greta', 'Hollis', 'Ingrid', 'Jasper', 'Kavi', 'Leontine', 'Marlowe', 'Nadia', 'Oren', 'Priya', 'Rafferty', 'Signe', 'Tamsin', 'Uriel', 'Vesna', 'Wilhelmina', 'Anwen', 'Bodhi', 'Caspian', 'Delphine', 'Emeric', 'Fiadh', 'Gwendolyn', 'Hektor', 'Ilaria', 'Joaquin', 'Katarzyna', 'Lachlan', 'Mirembe', 'Niamh', 'Ottoline', 'Persis', 'Quentin', 'Rosalind', 'Solveig', 'Thaddeus', 'Ursula', 'Valentin', 'Wendell', 'Xanthe', 'Yusuf', 'Zofia', 'Anaïs', 'Beatrix', 'Casimir', 'Dashiell', 'Eilidh', 'Fabrizio', 'Genoveva', 'Hyacinth', 'Isolde', 'Jarrah', 'Kestrel', 'Ludovic', 'Mirabel', 'Nikolai', 'Oleander', 'Pilar', 'Qadira', 'Ronan', 'Sunniva', 'Tarquin', 'Ulrik', 'Verity', 'Wolfgang', 'Yevgenia'];
export const surnames = ['Abernathy', 'Brightwater', 'Castellane', 'Duvalier', 'Everhart', 'Fairweather', 'Galloway', 'Hartwell', 'Ibarra-Kane', 'Jorgenssen', 'Kowalczyk', 'Lindqvist', 'Marchetti', 'Nakashima-Roe', 'Okonkwo', 'Pemberton', 'Quintero', 'Rasmussen', 'Sorensen', 'Thackeray', 'Underhill', 'Vasquez-Holt', 'Whitcombe', 'Xylander', 'Yarrow', 'Zielinski', 'Ashdown', 'Bellweather', 'Cordovan', 'Delacroix-Tan', 'Ellsworth', 'Featherstone', 'Grimaldi', 'Holloway', 'Iversen', 'Juniper', 'Kirkbride', 'Lockhart', 'Montclair', 'Nightingale', 'Oyelaran', 'Pellegrino', 'Ravensworth', 'Silverthorne', 'Tremblay', 'Vantongeren', 'Wexford', 'Zaragoza', 'Achterberg', 'Blackwood', 'Carrasco', 'Drummond', 'Eastwick', 'Fontaine', 'Granville', 'Hawthorne', 'Ingersoll', 'Jankowski', 'Kaczmarek', 'Lindstrom', 'Marchbanks', 'Nordstrand', 'Oleandra', 'Prendergast', 'Quillfeather', 'Ravenscroft', 'Stroganov', 'Thistlewood', 'Umberland', 'Vandergraaf', 'Winterbourne', 'Xanthopoulos', 'Yarborough', 'Zhelezny', 'Applewhite', 'Brennan-Osei', 'Calloway', 'Dunmore', 'Ehrenfeld', 'Fitzwilliam', 'Goldenberg', 'Hollingsworth', 'Ivarsson', 'Jamshidi', 'Karlovassi', 'Lautenberg', 'Merriweather', 'Nakamura-Lind', 'Ostrowski', 'Pettigrew', 'Quenneville', 'Rothermere', 'Sandoval-Rey', 'Trelawney', 'Ulvaeus', 'Vanterpool', 'Wollstonecraft', 'Ziegler', 'Abramowicz', 'Bellingham', 'Chaudhary', 'Delacourt', 'Engelhardt', 'Farnsworth', 'Gallardo', 'Hensleigh', 'Ivanovich', 'Jarrowby'];
