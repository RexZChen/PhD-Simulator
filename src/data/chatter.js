...
export const advisorPings = {
  calm: ['Nice progress. Keep going.', 'Saw your update — good. Let’s discuss next time.', 'No rush on anything this week. (Really.)'],
  busy: ['Traveling this week. Send a written update?', 'Can we push our meeting? Something came up.', 'Reply to the collaborators when you can — today would be good.'],
  pressed: ['Where are we on the draft?', 'Any update? Deadline is close.', 'Did you see my comments? All of them?', 'We need to move faster on this.'],
